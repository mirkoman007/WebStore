...
public class CartFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        List<Item> cart = (List<Item>)((HttpServletRequest)request).getSession().getAttribute(Constants.Session.CART_ITEMS);
        ...
        request.setAttribute(Constants.Request.SUBTOTAL, subtotal);
