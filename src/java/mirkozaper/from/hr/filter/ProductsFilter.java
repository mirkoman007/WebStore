...
public class ProductsFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        try {
            List<ProductVM> products = RepositoryFactory.getRepository().selectProductsByAdmin();
            request.setAttribute(Constants.Request.ADMIN_PRODUCTS, products);
        } catch (Exception ex) {
            Logger.getLogger(ProductsFilter.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
